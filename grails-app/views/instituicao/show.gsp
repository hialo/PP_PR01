	...
	<body>
		...
		<div id="show-instituicao" class="content scaffold-show" role="main">
			...
			<ol class="property-list instituicao">
				...
				<g:if test="${instituicaoInstance?.endereco}">
				<li class="fieldcontain">
					<span id="endereco-label" class="property-label"><g:message code="instituicao.endereco.label" default="Endereco" /></span>
					
						<span class="property-value" aria-labelledby="endereco-label"><g:fieldValue bean="${instituicaoInstance}" field="endereco"/></span>
