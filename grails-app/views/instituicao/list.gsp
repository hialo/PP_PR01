			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="endereco" title="${message(code: 'instituicao.endereco.label', default: 'Endereco')}" />
				...
				<g:each in="${instituicaoInstanceList}" status="i" var="instituicaoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${instituicaoInstance.id}">${fieldValue(bean: instituicaoInstance, field: "endereco")}</g:link></td>
